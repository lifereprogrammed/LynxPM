...
namespace LynxPMCore.Controllers
{
    public class ConditionsController : Controller
    {
        ...
        public ConditionsController(LynxPMContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ConditionID,ConditionName,ConditionDescription,ConditionDisplayLetter")] Condition condition)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("ConditionID,ConditionName,ConditionDescription,ConditionDisplayLetter")] Condition condition)
        {
